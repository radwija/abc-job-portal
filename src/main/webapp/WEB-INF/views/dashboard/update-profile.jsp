									...
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												<h1 class="modal-title fs-5" id="experiencesLabel">Add
													Experience</h1>
											...
											<div class="modal-body">
												<div class="form-floating mb-3">
													<input type="text" class="form-control" id="position"
														name="position"> <label for="position">Position</label>
												</div>
												<div class="form-floating mb-3">
													<input type="date" class="form-control" id="startDateEX"
														name="startDateEX"> <label for="startDateEX">Start
														Date</label>
												</div>
												<div class="form-floating mb-3">
													<input type="date" class="form-control" id="endDateEX"
														name="endDateEX"> <label for="endDateEX">End
														Date</label>
												</div>
												<div class="form-floating mb-3">
													<input type="text" class="form-control" id="companyName"
														name="companyNameEX"> <label for="companyName">Company
														Name</label>
												</div>
											</div>
							...
							<div class="d-flex">
								...
								<div class="modal fade" id="educations" tabindex="-1" aria-labelledby="educationsLabel"
									...
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												<h1 class="modal-title fs-5" id="educationsLabel">Add
													Education</h1>
												<button type="button" class="btn-close" data-bs-dismiss="modal"
													aria-label="Close"></button>
											</div>
											<div class="modal-body">
												<div class="form-floating mb-3">
													<input type="text" class="form-control" id="intitutionName"
														name="intitutionName"> <label for="intitutionName">Intitution
														Name</label>
												</div>
												<div class="form-floating mb-3">
													<input type="date" class="form-control" id="startDateED"
														name="startDateED"> <label for="startDateED">Start
														Date</label>
												</div>
												<div class="form-floating mb-3">
													<input type="date" class="form-control" id="endDateED"
														name="endDateED"> <label for="endDateED">End
														Date</label>
												</div>
												<div class="form-floating mb-3">
													<input type="text" class="form-control" id="educationName"
														name="educationName"> <label for="educationName">Education
														Name</label>
												</div>
											</div>
											<div class="modal-footer">
					...
					<div class="row">
						<div class="col-4">
							<div class="shadow-sm p-3 mb-5 bg-white "
								...
								<br>
								<button type="button" class="btn btn-primary" style="width: 100%; border-radius: 100px;"
									data-bs-toggle="modal" data-bs-target="#editBio">Edit bio</button>
								<div class="modal fade" id="editBio" tabindex="-1" aria-labelledby="editBioLabel"
									aria-hidden="true">
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
											...
											<div class="modal-body">
												<form action="update-profile" method="post">
													...
													<div class="form-floating mb-3">
														<textarea class="form-control" name="about" id="about" cols="10"
															style="border-radius: 20px;">${about}</textarea>
						...
						<div class="col-8">
							...
							<div class="shadow-sm p-3 mb-5 bg-white"
								...
								<!-- Add new experience -->
								<div class="modal fade" id="addExperience" tabindex="-1" aria-labelledby="editBioLabel"
									aria-hidden="true">
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
											...
											<div class="modal-body">
												<form action="add-experience" method="post">
													...
													<div class="form-floating mb-3">
														<input type="date" class="form-control" id="startDateEX"
															name="startDateEX" required> <label for="startDateEX">Start
															Date</label>
													</div>
													<div class="form-floating mb-3">
														<input type="date" class="form-control" id="endDateEX"
																...
																<form action="edit-experience-${e.getExperienceId()}"
																	...
																	<div class="form-floating mb-3">
																		<input type="text" class="form-control"
																			...
																			value="${e.getPosition()}" required>
																		<label for="position" required>Position</label>
																	</div>
																	<div class="form-floating mb-3">
																		<input type="date" class="form-control"
																			id="startDateEX" name="startDateEX"
																			value="${e.getStartDate()}" required>
																		<label for="startDateEX">Start Date</label>
																	</div>
																	<div class="form-floating mb-3">
																		<input type="date" class="form-control"
																			id="endDateEX" name="endDateEX"
																			value="${e.getEndDate()}" required>
																		<label for="endDateEX">End Date</label>
																	</div>
																	<div class="form-floating mb-3">
																		<input type="text" class="form-control"
																			id="companyName" name="companyNameEX"
																			value="${e.getCompanyName()}" required>
																		<label for="companyName">Company
																			Name</label>
																	</div>
																	<button type="submit" class="btn btn-light"
																		style="border-radius: 100px">Edit
																		experience</button>
																</form>
															</div>
														</div>
							...
							<div class="shadow-sm p-3 mb-5 bg-white"
								...
								<!-- Add new education -->
								<div class="modal fade" id="addEducation" tabindex="-1" aria-labelledby="editBioLabel"
									aria-hidden="true">
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
											...
											<div class="modal-body">
												<form action="add-education" method="post">
													...
													<div class="form-floating mb-3">
														<input type="date" class="form-control" id="startDateED"
															name="startDateED" required> <label for="startDateED">Start
															Date</label>
													</div>
													<div class="form-floating mb-3">
														<input type="date" class="form-control" id="endDateED"
													...
													<div class="modal-content">
														...
														<div class="modal-body">
															<form action="edit-education-${e.getEducationId()}"
																...
																<div class="form-floating mb-3">
																	<input type="text" class="form-control"
																		id="intitutionName" name="intitutionName"
																		value="${e.getIntitutionName()}" required>
																	<label for="intitutionName">Intitution
																		Name</label>
																</div>
																<div class="form-floating mb-3">
																	<input type="date" class="form-control"
																		id="startDateED" name="startDateED"
																		value="${e.getStartDate()}" required>
																	<label for="startDateED">Start Date</label>
																</div>
																<div class="form-floating mb-3">
																	<input type="date" class="form-control"
																		id="endDateED" name="endDateED"
																		value="${e.getEndDate()}" required>
																...
																<div class="form-floating mb-3">
																	<input type="text" class="form-control"
																		...
																		value="${e.getEducationName()}" required> <label
